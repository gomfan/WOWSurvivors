...
namespace Gyvr.Mythril2D
{
    public class UIPlayerControllerFeedback : MonoBehaviour
    {
        ...
        private void Start()
        {
            m_playerController = (PlayerController)GameManager.Player.controller;
        ...
        private void Update()
        {
            ...
            {
                m_spriteRenderer.color = Color.Lerp(m_spriteRenderer.color, new(1.0f, 1.0f, 1.0f, 0.0f), m_hideAnimationSpeed * Time.unscaledDeltaTime);
            }
        }
    }
}
